...
class Test_SearchByName_006:
    ...
    def test_searchByName(self,setup):
        self.logger.info("Starting - Test_SearchByName_006")
        self.driver=setup
       ...
       # searchCust.clickOnHide()
        time.sleep(5)
        searchCust.setFirstname("Victoria")
        searchCust.setLastname("Terces")
        searchCust.clickOnSearch()
        time.sleep(3)
        status=searchCust.searchByCustomerName("Victoria Terces")
        print(status)
        assert True==status

        self.logger.info("---------------Completed - Test_SearchByName_006----------------")
